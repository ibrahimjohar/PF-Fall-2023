...
void inputCourse(struct Course *course); //function prototype
void saveToFile(struct Course *courses, int count); //function prototype
void viewTranscript(); //function prototypes
float calculateCGPA(struct Course *courses, int count); //function prototype
float calculateSGPA(struct Course *courses, int count, int semester); //function prototype
...
int main()
{
    ...
    do {
        printf("Press list number to enter set instructions.");
...
// Function definition to input course information
...
// Function definition to save course data to a file
void saveToFile(struct Course *courses, int count)
{
    FILE *file = fopen("tran.txt", "a");
...
// Function definition to view transcript
void viewTranscript()
{
    FILE *file = fopen("tran.txt", "r");
...
// Function definition to calculate CGPA
...
// Function definition to calculate SGPA for a specific semester
